...
public class ProController {
	...
	public ModelAndView adminFaqInsertOk(HttpServletRequest request, HttpServletResponse response, AdminFaqDto adminFaqDto) {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView adminFaqUpdateOk(HttpServletRequest request, HttpServletResponse response, AdminFaqDto adminFaqDto) {		
		ModelAndView mav = new ModelAndView();
		mav.addObject("request",request);
		mav.addObject("adminFaqDto",adminFaqDto);
