											...
											<c:set value="0" var="count" />
													<c:forEach items="${maplist}" var="map">
														<c:forEach items="${map.value}" var="list">
															<tr class="parent ${map.key } faqparent_ej">
																...
																<td class=" ">${list.up_category }>${list.down_category }</td>
																<td class=" ">
																	${list.title }
																	<a href="javascript:child('${list.content}','plus_ej-${count}')" id="plus_ej-${count}" class="float float_ej floatgreen_ej">
																		<i id="plus2_ej-${count}" class="fa fa-plus my-float"></i>
																	</a>
																	<a href="javascript:child('${list.content}','minus_ej-${count}')" id="minus_ej-${count}" class="float float_ej floatred_ej">
